...
for(var a in this.img.dataset)this.img.setAttribute(a,this.img.dataset[a]),this.img.removeAttribute("data-"+a)}}}(document,window),function(a,b){"use strict";var c=function(c){c.preventDefault();var d=new b.AnimateMutate({hero:"cover__hero",title:["cover__titleLink",!0],imgList:"cover__heroImg--list",imgBlur:"cover__heroImg--blur"},this),e=d.el.context,f=d.el.hero,g=d.el.title,h=d.el.imgList,i=function(){
j.img.complete&&d.complete&&(h.node.style.transition=d.el.imgBlur.node.style.transition="opacity .5s linear",b.requestAnimationFrame(function(){h.node.style.opacity=d.el.imgBlur.node.style.opacity=""}))};d.mutate=function(){var b=a.getElementsByClassName("mainContent")[0],c=b.cloneNode(!0),d=e.node.cloneNode(!0);e.node.parentNode.insertBefore(d,e.node.nextSibling),c.replaceChild(e.node,c.getElementsByClassName("post")[0]),
...
i()},d.cleanUpAfter=f.node;var j=new b.RequestImg(h.node,i);d.animate(),j.mutateAtts()},d=function(){for(var b=a.getElementsByClassName("post--postExpandJS"),d=0;d<b.length;d++){var e=b[d];e.addEventListener("click",c,!0)}};"loading"===a.readyState||"interactive"===a.readyState?b.addEventListener("load",d,!1):d()}(document,window);