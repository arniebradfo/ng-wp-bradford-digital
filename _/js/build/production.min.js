...
imgList:"cover__heroImg--list",imgBlur:"cover__heroImg--blur"},this),e=d.el.context,f=d.el.hero,g=d.el.title;d.mutate=function(){var b=a.getElementsByClassName("mainContent")[0],c=b.cloneNode(!0),d=e.node.cloneNode(!0);e.node.parentNode.insertBefore(d,e.node.nextSibling),c.replaceChild(e.node,c.getElementsByClassName("post")[0]),c.classList.remove("mainContent--active"),e.node.classList.remove("post--list"),
e.node.classList.add("post--full"),a.body.appendChild(c),a.body.removeChild(b),a.getElementById("mainNav--opener").checked=!1,c.classList.add("mainContent--active"),f.node.style.transform=g.node.style.transform="none"},d.invert=function(){f.node.style.transition=g.node.style.transition="none";var a="translateZ(0.0001px) ",b=f.first.rect.left+f.first.rect.width/2-(f.last.rect.left+f.last.rect.width/2);
