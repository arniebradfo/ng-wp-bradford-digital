...
for(var a in this.img.dataset)this.img.setAttribute(a,this.img.dataset[a]),this.img.removeAttribute("data-"+a)}}}(document,window),function(a,b){"use strict";var c=function(c){c.preventDefault();for(var d,e=c.target;;){if(e.href){d=e.href;break}e=e.parentElement}var f=new b.AnimateMutate({hero:"cover__hero",title:["cover__titleLink",!0],imgList:"cover__heroImg--list",imgBlur:"cover__heroImg--blur"},this),g=f.el.context,h=f.el.hero,i=f.el.title,j=f.el.imgList,k=function(){
l.img.complete&&f.complete&&(j.node.style.transition=f.el.imgBlur.node.style.transition="opacity .5s linear",b.requestAnimationFrame(function(){j.node.style.opacity=f.el.imgBlur.node.style.opacity=""}))};f.mutate=function(){var b=a.getElementsByClassName("mainContent")[0],c=b.cloneNode(!0),d=g.node.cloneNode(!0);g.node.parentNode.insertBefore(d,g.node.nextSibling),c.replaceChild(g.node,c.getElementsByClassName("post")[0]),
c.classList.remove("mainContent--active"),g.node.classList.remove("post--list"),g.node.classList.add("post--full"),a.body.appendChild(c),a.body.removeChild(b),a.getElementById("mainNav--opener").checked=!1,c.classList.add("mainContent--active"),h.node.style.transform=i.node.style.transform="none"},f.invert=function(){h.node.style.transition=i.node.style.transition="none";var a="translateZ(0.0001px) ",b=h.first.rect.left+h.first.rect.width/2-(h.last.rect.left+h.last.rect.width/2);
a+="translateX("+b+"px) ";var c=h.first.rect.top+h.first.rect.height/2-(h.last.rect.top+h.last.rect.height/2);a+="translateY("+c+"px) ";var d=h.first.rect.width/h.last.rect.width;a+="scaleX("+d+") ";var e=h.first.rect.height/h.last.rect.height;a+="scaleY("+e+") ",h.node.style.transform=a;var f=i.first.rect.width*parseFloat(i.last.compStyle.lineHeight)/parseFloat(i.first.compStyle.lineHeight),g="translateZ(0.0002px) ",j=i.first.rect.left+i.first.rect.width/2-(i.last.rect.left+f/2);
g+="translateX("+j+"px) ";var k=i.first.rect.bottom-i.last.rect.bottom;g+="translateY("+k+"px) ";var l=i.first.rect.width/f;g+="scale("+l+") ",i.node.style.width=f+"px",i.node.style.transform=g,this.el.imgList.node.style.opacity=0,this.el.imgBlur.node.style.opacity=.6},f.play=function(){h.node.style.transition=i.node.style.transition="",h.node.style.transform=i.node.style.transform=""},f.cleanUp=function(){
k()},f.cleanUpAfter=h.node;var l=new b.RequestImg(j.node,k),m=new b.XMLHttpRequest;m.open("GET",d,!0),console.dir(m),m.timeout=5e3,m.setRequestHeader("WP-Request-Type","GetPage"),m.onload=function(){console.log(m.responseText)},m.send(),f.animate(),l.mutateAtts()},d=function(){for(var b=a.getElementsByClassName("post--postExpandJS"),d=0;d<b.length;d++){var e=b[d];e.addEventListener("click",c,!0)}};"loading"===a.readyState||"interactive"===a.readyState?b.addEventListener("load",d,!1):d();
}(document,window);