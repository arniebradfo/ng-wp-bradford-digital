...
"use strict";b.navigationJS_default=function(c,d){var e=new b.AnimateMutate({},c);e.mutate=function(){},e.invert=function(){},e.play=function(){},e.cleanUp=function(){};var f=new b.XMLHttpRequest;f.open("GET",d,!0),f.timeout=5e3,f.setRequestHeader("X-Requested-With","XMLHttpRequest"),f.setRequestHeader("WP-Request-Type","GetPage"),f.onload=function(){var b=a.createElement("div");b.innerHTML=f.responseText,
a.querySelector(".mainNav").innerHTML=b.querySelector(".mainNav").innerHTML,a.querySelector(".postListWrapper").innerHTML=b.querySelector(".postListWrapper").innerHTML,a.querySelector(".mainContent").innerHTML=b.querySelector(".mainContent").innerHTML},f.onerror=f.onabort=f.ontimeout=function(){console.log("ajax failed"),b.location=d};var g=function(){},h=function(){return f.readyState},i=[[h,4]],j=new b.ProgressTracker(i,g);
j.update=function(){},f.send(),e.animate(),j.start()}}(document,window),function(a,b){"use strict";b.navigationJS_mainNavToggle=function(c,d){c=null==c?a.querySelector(".mainNav__toggle"):c,"#navOpen"===b.location.hash?(c.hash="#navClosed",a.body.classList.remove("body--mainNavClosed"),a.body.classList.add("body--mainNavOpen")):(c.hash="#navOpen",a.body.classList.remove("body--mainNavOpen"),a.body.classList.add("body--mainNavClosed"));
}}(document,window),function(a,b){"use strict";b.navigationJS_postExpand=function(c,d){console.dir(this),d=b.addAjaxQueryString(d,"getpage");var e=new b.AnimateMutate({hero:"cover__hero",title:["cover__titleLink",!0],imgList:"cover__heroImg--list",imgBlur:"cover__heroImg--blur",loadBar:"button"},c),f=e.el.context,g=e.el.hero,h=e.el.title,i=e.el.imgList,j=e.el.loadBar,k=j.node.getElementsByClassName("button__loadbar")[0];
e.mutate=function(){var c=a.getElementsByClassName("mainContent")[0],d=c.cloneNode(!0),e=f.node.cloneNode(!0);f.node.parentNode.insertBefore(e,f.node.nextSibling),d.replaceChild(f.node,d.getElementsByClassName("postItem")[0]),f.node.classList.remove("post--list"),f.node.classList.add("post--full"),a.body.appendChild(d),a.body.removeChild(c),b.navigationJS_mainNavToggle(),g.node.style.transform=h.node.style.transform=j.node.style.transition="none";
},e.invert=function(){g.node.style.transition=h.node.style.transition=j.node.style.transition="none";var a=g.first.rect.left+g.first.rect.width/2-(g.last.rect.left+g.last.rect.width/2),b=g.first.rect.top+g.first.rect.height/2-(g.last.rect.top+g.last.rect.height/2),c=g.first.rect.width/g.last.rect.width,d=g.first.rect.height/g.last.rect.height,e="translateZ(0.0001px) ";e+="translateX("+a+"px) ",e+="translateY("+b+"px) ",
e+="scaleX("+c+") ",e+="scaleY("+d+") ",g.node.style.transform=e;var f=h.first.rect.width*parseFloat(h.last.compStyle.lineHeight)/parseFloat(h.first.compStyle.lineHeight),i="translateZ(0.0002px) ",k=h.first.rect.left+h.first.rect.width/2-(h.last.rect.left+f/2);i+="translateX("+k+"px) ";var l=h.first.rect.bottom-h.last.rect.bottom;i+="translateY("+l+"px) ";var m=h.first.rect.width/f;i+="scale("+m+") ",
h.node.style.width=f+"px",h.node.style.transform=i;var n=j.first.rect.left-j.last.rect.left,o=j.first.rect.top-j.last.rect.top;j.node.style.transform="translateZ(0.0001px) translateX("+n+"px) translateY("+o+"px)",this.el.imgList.node.style.opacity=0,this.el.imgBlur.node.style.opacity=.6},e.play=function(){g.node.style.transition=h.node.style.transition=j.node.style.transition="",g.node.style.transform=h.node.style.transform=j.node.style.transform="";
},e.cleanUpAfter=g.node;var l=new b.RequestImg(i.node),m=new b.XMLHttpRequest;m.open("GET",d,!0),m.timeout=5e3,m.setRequestHeader("X-Requested-With","XMLHttpRequest"),m.setRequestHeader("WP-Request-Type","GetPage"),m.onload=function(){var b=a.createElement("div");b.innerHTML=m.responseText,console.log(b),f.node.getElementsByClassName("excerpt")[0].innerHTML="",f.node.getElementsByClassName("frame")[0].innerHTML=b.getElementsByClassName("frame")[0].innerHTML;
};var n=function(){i.node.style.transition=e.el.imgBlur.node.style.transition="opacity .5s linear",b.requestAnimationFrame(function(){i.node.style.opacity=e.el.imgBlur.node.style.opacity=""})},o=function(){return m.readyState},p=[[o,4],[l.readyState,l.readyStateMax]],q=new b.ProgressTracker(p,n);q.update=function(){k.style.transform="scaleX("+this.readyState+")"},m.send(),e.animate(),q.start(),l.mutateAtts();
}}(document,window),function(a,b){var c={forward:"navigationJS_default",back:"navigationJS_default"},d=function(){var c=a.querySelectorAll("[data-routersetstate]");c.forEach(function(a){b[a.dataset.routersetstate](a,a.href)})},e=function(a,d){a.dataset.navforward||(a.dataset.navforward=c.forward),a.dataset.navback||(a.dataset.navback=c.back),console.log("pushState"),b.history.pushState({navforward:a.dataset.navforward,
navback:a.dataset.navback},"",d),console.log(b.history.state),b[a.dataset.navforward](a,d)},f=function(a,b){for(continueSearching=!0;;){if(a.dataset.navforward||"BODY"===a.tagName)return void e(a,b);a=a.parentElement}},g=function(c){console.log(c),console.log(b.history),console.log("popState"),null!=c.state&&b[c.state.navback](a.body,a.location)},h=function(c){var d=c||b.event;if(!(d.metaKey||d.ctrlKey||d.altKey||d.shiftKey)){
for(var e=d.target;;){if("BODY"===e.tagName)return;if("A"===e.tagName)break;e=e.parentElement}var g=e;if(g.href){if(g.href===b.location.href&&!b.location.hash)return console.log("you're already on that page"),void d.preventDefault();var h=new RegExp("/wp-","g");!(g.href.indexOf(a.domain)>-1||g.href.indexOf(":")===-1)||g.href.match(h)||g.href.match(/\/feed/g)||(d.preventDefault(),f(g,g.href))}}},i=function(){
b.addEventListener("popstate",g,!1),a.addEventListener("click",h,!0),d()};"loading"===a.readyState?a.addEventListener("DOMContentLoaded",i,!1):i()}(document,window);