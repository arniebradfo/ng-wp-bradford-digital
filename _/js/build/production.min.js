...
a.addEventListener("click",d,!0)};"loading"===a.readyState?a.addEventListener("DOMContentLoaded",e,!1):e()}(document,window),function(a,b){"use strict";b.postExpand=function(c,d,e){e=b.addAjaxQueryString(e,"getpage"),console.log(e);var f=new b.AnimateMutate({hero:"cover__hero",title:["cover__titleLink",!0],imgList:"cover__heroImg--list",imgBlur:"cover__heroImg--blur",loadBar:"button"},d),g=f.el.context,h=f.el.hero,i=f.el.title,j=f.el.imgList,k=f.el.loadBar,l=k.node.getElementsByClassName("button__loadbar")[0];
