...
j.update=function(){},f.send(),e.animate(),j.start()}}(document,window),function(a,b){"use strict";b.navigationJS_mainNavToggle=function(b,c){console.dir(this),console.log(b),a.body.classList.contains("body--mainNavOpen")?(a.body.classList.remove("body--mainNavOpen"),a.body.classList.add("body--mainNavClosed")):(a.body.classList.remove("body--mainNavClosed"),a.body.classList.add("body--mainNavOpen"));
...
e.mutate=function(){var c=a.getElementsByClassName("mainContent")[0],d=c.cloneNode(!0),e=f.node.cloneNode(!0);f.node.parentNode.insertBefore(e,f.node.nextSibling),d.replaceChild(f.node,d.getElementsByClassName("postItem")[0]),d.classList.remove("mainContent--active"),f.node.classList.remove("post--list"),f.node.classList.add("post--full"),a.body.appendChild(d),a.body.removeChild(c),b.navigationJS_mainNavToggle(),
d.classList.add("mainContent--active"),g.node.style.transform=h.node.style.transform=j.node.style.transition="none"},e.invert=function(){g.node.style.transition=h.node.style.transition=j.node.style.transition="none";var a=g.first.rect.left+g.first.rect.width/2-(g.last.rect.left+g.last.rect.width/2),b=g.first.rect.top+g.first.rect.height/2-(g.last.rect.top+g.last.rect.height/2),c=g.first.rect.width/g.last.rect.width,d=g.first.rect.height/g.last.rect.height,e="translateZ(0.0001px) ";
...
k.style.transform="scaleX("+this.readyState+")"},m.send(),e.animate(),q.start(),l.mutateAtts()}}(document,window),function(a,b){var c,d={forward:"navigationJS_default",back:"navigationJS_default"},e=function(a,e){c=!1,a.dataset.navforward||(a.dataset.navforward=d.forward),a.dataset.navback||(a.dataset.navback=d.back),b.history.pushState({navforward:a.dataset.navforward,navback:a.dataset.navback},"",e),
b[a.dataset.navforward](a,e)},f=function(a,b){for(c=!0;c;)console.log(a.dataset.navforward),(a.dataset.navforward||"BODY"===a.tagName)&&e(a,b),a=a.parentElement},g=function(c){null!==c.state&&b[c.state.navback](a.body,a.location)},h=function(c){var d=c||b.event;if(!(d.metaKey||d.ctrlKey||d.altKey||d.shiftKey)){for(var e=d.target;;){if("BODY"===e.tagName)return;if("A"===e.tagName)break;e=e.parentElement;
}var g=e;if(console.log(g.href),console.log(b.location.href),g.href===b.location.href&&!b.location.hash)return console.log("you're already on that page"),void d.preventDefault();var h=new RegExp("/wp-","g");!(g.href.indexOf(a.domain)>-1||g.href.indexOf(":")===-1)||g.href.match(h)||g.href.match(/\/feed/g)||(d.preventDefault(),f(g,g.href))}},i=function(){b.addEventListener("popstate",g,!1),a.addEventListener("click",h,!0);
};"loading"===a.readyState?a.addEventListener("DOMContentLoaded",i,!1):i()}(document,window);