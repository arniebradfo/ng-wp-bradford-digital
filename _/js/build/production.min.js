...
if((f.href.indexOf(a.domain)>-1||f.href.indexOf(":")===-1)&&!f.href.match(g)&&!f.href.match(h)&&!f.href.match(/\/feed/g)){d.preventDefault();for(var i={postExpand:"post--postExpandJS"},j=f;;){if("BODY"===j.tagName)return;for(var k in i)if(j.classList.contains(i[k]))return b.history.pushState({type:k},"",f.href),void b[k](d,j,f.href);j=j.parentElement}}}}},e=function(){b.addEventListener("popstate",c,!1),
